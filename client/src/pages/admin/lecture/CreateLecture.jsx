    ...
    return (
        <div className="flex-1 mx-10">
            ...
            <div className="space-y-4">
                ...
                <div className='mt-10'>
                    {
                        lectureLoading ? (<p>Loading lecture...</p>) : lectureError ? (<p>Failed to load lectures.</p>) : lectureData.lectures.length === 0 ? <p>No lecture available</p> :
                            (
                                lectureData.lectures.map((lecture, index) => (

                                    <Lecture key={lectureData._id} lecture={lecture} 
                                    courseId = {courseId}
                                    index={index} />
                                ))
