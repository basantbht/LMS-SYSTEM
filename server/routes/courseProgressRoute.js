...
courseProgressRouter.post("/:courseId/complete", isAuthenticated, markAsCompleted);
courseProgressRouter.post("/:courseId/incomplete", isAuthenticated, markAsInCompleted);
